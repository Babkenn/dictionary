...
public class ReadCategoryThreeActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      englishWordsesAdapter = new   EnglishWordsAdapter(this, MainActivity.englishCategoryThreeWordses);
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                values.put(EnglishWordContract.EnglishWordEntry.COLUMN_NAME_CATEGORY_THREE,(String) null);
                values.put(EnglishWordContract.EnglishWordEntry.COLUMN_NAME_CATEGORY_THREE_TRANSLATE,(String)null);
                String[] arg= new String[]{englishWordTextView.getText().toString()};
                db.update(EnglishWordContract.EnglishWordEntry.TABLE_NAME, values, EnglishWordContract.EnglishWordEntry.COLUMN_NAME_CATEGORY_THREE +"=?", arg);

                //delete selected itemfrom  array
                MainActivity.englishCategoryThreeWordses.remove(position);
