...
public class ReadCategoryFourActivity extends AppCompatActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        englishWordsesAdapter = new   EnglishWordsAdapter(this, MainActivity.englishCategoryFourWordses);
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                values.put(EnglishWordContract.EnglishWordEntry.COLUMN_NAME_CATEGORY_FOUR,(String) null);
                values.put(EnglishWordContract.EnglishWordEntry.COLUMN_NAME_FILMS_CATEGORY_FOUR,(String)null);
                String[] arg= new String[]{englishWordTextView.getText().toString()};
                db.update(EnglishWordContract.EnglishWordEntry.TABLE_NAME, values, EnglishWordContract.EnglishWordEntry.COLUMN_NAME_CATEGORY_FOUR +"=?", arg);
                //delete selected itemfrom  array
                MainActivity.englishCategoryFourWordses.remove(position);
