...
public class ReadCategoryFiveActivity extends AppCompatActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        englishWordsesAdapter = new   EnglishWordsAdapter(this, MainActivity.englishCategoryFiveWordses);
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                values.put(EnglishWordContract.EnglishWordEntry.COLUMN_NAME_CATEGORY_FIVE,(String) null);
                values.put(EnglishWordContract.EnglishWordEntry.COLUMN_NAME__CATEGORY_FIVE_TRANLSATE,(String)null);
                String[] arg= new String[]{englishWordTextView.getText().toString()};
                db.update(EnglishWordContract.EnglishWordEntry.TABLE_NAME, values, EnglishWordContract.EnglishWordEntry.COLUMN_NAME_CATEGORY_FIVE +"=?", arg);


                //delete selected itemfrom  array
                MainActivity.englishCategoryFiveWordses.remove(position);
